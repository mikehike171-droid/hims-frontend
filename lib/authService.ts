...
const SETTINGS_API_URL = process.env.NEXT_PUBLIC_SETTINGS_API_URL || 'http://13.63.125.161:3002/api';
...
const getSettingsApiUrl = () => {
  ...
  return SETTINGS_API_URL || localStorage.getItem('SETTINGS_API_URL');
};
