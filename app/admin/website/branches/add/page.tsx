...
import { ArrowLeft, Save, MapPin, ImagePlus, X, Plus, Info } from "lucide-react"
...
export default function AddBranchPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      setLoading(true)
      await settingsApi.createBranch(formData)
      ...
      <div className="p-6 space-y-6 max-w-5xl mx-auto">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold font-serif text-[#1a2e5a]">Add New Branch</h1>
          </div>
        </div>
            ...
            <Card className="border-none shadow-sm overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="slug" className="text-slate-700 font-bold">URL Slug (autogenerated if empty)</Label>
                    <Input
                      id="slug"
          ...
          <div className="space-y-6">
            ...
            <Card className="border-none shadow-sm overflow-hidden">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {formData.image_url ? (
                    <div className="relative w-full aspect-video rounded-xl overflow-hidden shadow-sm shadow-indigo-100">
                      <img 
            ...
            <div className="pt-4">
              <Button onClick={handleSave} disabled={loading} className="w-full h-12 rounded-xl bg-primary text-lg font-bold shadow-lg shadow-indigo-100 hover:shadow-indigo-200 transition-all">
