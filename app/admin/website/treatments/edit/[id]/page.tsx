...
export default function EditTreatmentPage() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await settingsApi.updateTreatment(+id, payload)
      toast({
        title: "Success",
  ...
  if (!isAdmin && permissions && !hasPermission(permissions, 'admin/settings', 'view')) {
    return (
      <div className="p-20 text-center">
        <AlertTriangle className="h-12 w-12 text-red-500 mx-auto mb-4" />
        <h2 className="text-2xl font-bold">Access Denied</h2>
        <p className="text-gray-500 mt-2">You do not have permission to edit treatments.</p>
      </div>
    )
  }
